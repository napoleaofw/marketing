                                ...
                                <div class="col-xs-12 box-header-content">
                                    <div class="row">
                                        <section class="col-xs-6 ads-title-section">
                                            <h2 class="title ads-title"><a href="#" class="default-color ads-title-link">Título do anúncio</a></h2>
                                        </section>
                                    ...
                                    <div class="row section-group">
                                        <div class="col-xs-6">
                                            <section class="ads-address-section">
                                                <p class="ads-address">
                                                    <span class="ads-icon-container"><i class="fa fa-map-marker"></i></span>Rua do badanha, 900 ...
                                                </p>
